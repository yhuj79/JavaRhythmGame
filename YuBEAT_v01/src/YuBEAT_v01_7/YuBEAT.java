...
public class YuBEAT extends JFrame {
	...
	private Image scoreboardImage = new ImageIcon(Main.class.getResource("../images/scoreboard.png")).getImage();
	...
	private boolean isGameFinishScreen = false;
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen)
		{
			...
			if (game.getIsGameMusicEnd()) {
				isGameFinishScreen = true;
				isGameScreen = false;
			}
		}
		if (isGameFinishScreen) {
			g.drawImage(scoreboardImage, 600, 600, null);
			g.setColor(Color.WHITE);
			g.setFont(new Font("Elephant", Font.BOLD, 40));
			g.drawString(game.getmaxCount().toString(), 830, 205);
			g.drawString(game.getbreakCount().toString(), 830, 270);
			g.drawString(game.getGameScore().toString(), 800, 580);
		}
